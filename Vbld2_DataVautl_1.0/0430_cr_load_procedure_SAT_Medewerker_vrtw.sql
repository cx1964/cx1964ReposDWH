...
DROP PROCEDURE [dbo].[Load_S_Medewerker2_vrtrw]
GO

CREATE PROCEDURE Load_S_Medewerker2_vrtrw
AS
...
INSERT INTO S_Medewerker2_vrtrw
( 
    -- Hub key 
...
FROM 
(
     MERGE S_Medewerker2_vrtrw AS Target             --Target: Satellite
     USING 
     (
