-- File:  0801_cr_table_pit_medewerker.change_hash_key.v2.sql 0800_cr_table_pit_medewerker.sql
-- Functie: create pit table voor medewerker  

-- dit script vervalt als 0800_cr_table_pit_medewerker.sql is bijgewerkt.
-- Dit script experiment mbt change-hashkey
