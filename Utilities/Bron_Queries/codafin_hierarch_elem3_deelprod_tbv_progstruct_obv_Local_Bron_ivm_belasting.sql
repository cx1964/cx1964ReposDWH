-- Filenaam: codafin_hierarch_elem3_deelprod_tbv_progstruct_obv_Local_Bron_ivm_belasting.sql
-- Functie: Query deelproduct hierarchie tbv programmastructuur 
--          Dit script om gebouwd van werkend script
--          codafin_hierarch_elem3_deelprod_tbv_progstruct_obv_DWH_STG_ivm_belasting.sql  
