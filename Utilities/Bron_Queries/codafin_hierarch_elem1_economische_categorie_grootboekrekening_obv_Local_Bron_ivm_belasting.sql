-- Filenaam: codafin_hierarch_elem1_economische_categorie_grootboekrekening_obv_Local_Bron_ivm_belasting.sql
-- Functie:  query economische categorie (grootboekrekening) hierarchie
--           Deze query gebrukt local brontabel
--           Dit is een aangepaste versie van het werkende script 
--           codafin_hierarch_elem1_economische_categorie_grootboekrekening_obv_DWH_STG_ivm_belasting.sql
--           
...
-- extra       
inner join TestSourceDB3.codafin12.oas_group grp
       on (
