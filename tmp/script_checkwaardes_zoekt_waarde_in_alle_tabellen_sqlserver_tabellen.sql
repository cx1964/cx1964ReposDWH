-- Filenaam: script_checkwaardes_zoekt_waarde_in_alle_tabellen_sqlserver_tabellen.sql

use [dwh_stg] -- Aanpassen
...
BEGIN
	...
	set @schema = 'codafin12' --schema waarin de te doorzoeken tabellen staan
